            ...
            <div className="container mx-auto px-4">
                <div className="mx-auto max-w-6xl">
                    ...
                    <div className="flex gap-2 justify-center mb-8">
                        <Button onClick={() => setActiveTab("organize")} className={`rounded-lg px-6 py-3 text-sm font-medium transition-colors ${activeTab == "organize" ? "bg-primary text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200"}`}>Organized Applications</Button>
                    ...
                    <div className="relative mx-auto max-w-5xl overflow-hidden rounded-lg border border-gray-200 shadow-xl">
                        <Image src="/hero-img/hero1.png" alt="Organize Applications" width={1200} height={800}></Image>
                        <Image src="/hero-img/hero2.png" alt="Organize Applications" width={1200} height={800}></Image>
                        <Image src="/hero-img/hero3.png" alt="Organize Applications" width={1200} height={800}></Image>
                    </div>
                </div>
            </div>
        </section >
